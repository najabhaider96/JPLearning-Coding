...
HTTPClient http;
String requestUrl = "http://192.168.2.150:8080/events/last/deviceId/" + device_id + "/type/Light";

// Data Sending Time
unsigned long CurrentMillis, PreviousMillis, DataSendingTime = (unsigned long)1000 * 5;
...
void setup()
{
  ...
  delay(5000);
  Serial.println("\n\nWelcome to JP Learning\n");
  Serial.println("\nMosquitto MQTT Broker on Local Firmware Example\n");
  setup_wifi();
  get_lastEvent();
  mqtt_connect();
}
